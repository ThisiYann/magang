...
function WebhookModule.SendFishWebhook(fishId, metadata, data)
    ...
    local payload = {
        embeds = {{
            ...
            thumbnail = {
                url = WebhookModule.GetThumbnailURL(fishData.Icon) or "https://cdn.discordapp.com/attachments/1440154438105825413/1442672913223258353/IMG_20251125_082619.png?ex=6960f41a&is=695fa29a&hm=cfabf212e2b8b6f637b52dcc24065d3117478e318bd010ec2cb0135e22cbc1e7&"
            },
            image = {
                url = "https://cdn.discordapp.com/attachments/1440154438105825413/1442672913223258353/IMG_20251125_082619.png?ex=6960f41a&is=695fa29a&hm=cfabf212e2b8b6f637b52dcc24065d3117478e318bd010ec2cb0135e22cbc1e7&"
            },
            footer = {
                text = "ArtHub Webhook"
            },
        ...
        username = "ArtHub",
        avatar_url = "https://files.catbox.moe/i1ws54.jpeg"
    }
