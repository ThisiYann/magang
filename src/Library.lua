...
local LucideIcons = {}
pcall(function()
    LucideIcons = loadstring(game:HttpGet("https://raw.githubusercontent.com/ThisiYann/magang/refs/heads/main/src/icons.lua"))()
end)
...
function ArtUI(msg, delay, color, title, desc)
...
function ArtUI:Window(GuiConfig)
    ...
    GuiConfig.Footer = GuiConfig.Footer or "| made by @artaokei_"
