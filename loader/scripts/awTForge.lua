...
WebhookSection:AddToggle({
    ...
    Callback = function(v)
        ...
        if v then
            if webhook.url == "" then
                ArtUI("Please set webhook URL first!")
...
TeleportWorldSection:AddButton({
    ...
    Callback = function()
        ...
        if game.PlaceId == placeId then
            ArtUI("You are already in World 1!")
            return
        end
        ArtUI("Teleporting to World 1...")
        pcall(function()
...
TeleportWorldSection:AddButton({
    ...
    Callback = function()
        ...
        if game.PlaceId == placeId then
            ArtUI("You are already in World 2!")
            return
        end
        ArtUI("Teleporting to World 2...")
        pcall(function()
            TeleportService:Teleport(placeId, LocalPlayer)
        end)
    end
